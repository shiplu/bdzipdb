<?php include_once("code_finder.php"); code_finder(post,outline); ?>
...
<p>To use this view include and call the function code_finder with "post" and "outline".</p>
...
(</span><span style="color:#cc0000">"code_finder.php"</span><span style="color:#903aff">)</span><span>;</span> code_finder<span style="color:#903aff">(</span>post,outline<span style="color:#903aff">)</span>; <span style="color:#ff003a">?></span></div>
