<?php include_once("code_finder.php"); code_finder(post,inline); ?>
...
<p>To use this view include and call the function code_finder with "post" and "inline".</p>
...
<p><span style="font-style:italic">post</span> : This function call varies type of searching postal code wise or post office. Now post office has selected</p>
<p><span style="font-style:italic">inline</span> : Displaying the result generated from code_finder.php. inline equal shows as inner format</p>
...
(</span><span style="color:#cc0000">"code_finder.php"</span><span style="color:#903aff">)</span><span>;</span> code_finder<span style="color:#903aff">(</span>post,inline<span style="color:#903aff">)</span>; <span style="color:#ff003a">?></span></div>
</div>         
